...
protected:
	virtual BOOL OnIntialize() 
	{
		...
		//char foldername[] = "./scenedata/boat/";
		//char foldername[] = "./scenedata/car/";
		//char foldername[] = "./scenedata/crown/";
		//char foldername[] = "./scenedata/shuttle/";
		//char foldername[] = "./scenedata/teapot/";
		//char foldername[] = "./scenedata/violinCase/";
		//char foldername[] = "./scenedata/museum/";
		char foldername[] = "./scenedata/museum-01/";
