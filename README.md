...
![Original image](images/Original_RCMC.jpg?raw=true "Original image"){:height="50%" width="50%"} | ![Rendered image](images/RCMC_Rendering.png?raw=true "Rendered image"){:height="50%" width="50%"}
